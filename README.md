# 🚀 Rocket League Match Tracker v2.0.7
...
### 1. Download
Get the latest `RL-Tracker-v2.0.7` from [Releases](https://github.com/magnificolv/RocketTracker/releases).

### 2. Run
Double-click `RL-Tracker-v2.0.7`. A console window opens — **keep it running**.
...
|---------|------|---------|
| **v2.0.7** | Jun 28, 2026 | Bugfix: SPECTATOR skip invalid TeamNum, Avg Shot Power rounding, saves tracking |
